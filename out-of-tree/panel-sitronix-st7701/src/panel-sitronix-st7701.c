...
static void er_tft_4_58_1_gip_sequence(struct st7701 *st7701)
{
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xC0, 0x77, 0x00);
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xC1, 0x09, 0x08);
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xC2, 0x37, 0x02);
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xC3, 0x80, 0x05, 0x0D);
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xB0, 0x40, 0x14, 0x59, 0x10, 0x12, 0x08, 0x03, 0x09, 0x05, 0x1E, 0x05, 0x14, 0x10, 0x68, 0x33, 0x15);
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xB1, 0x40, 0x08, 0x53, 0x09, 0x11, 0x09, 0x02, 0x07, 0x09, 0x1A, 0x04, 0x12, 0x12, 0x64, 0x29, 0x29);
	st7701_switch_cmd_bkx(st7701, true, 3);
	ST7701_WRITE(st7701, 0xEF, 0x08);
	st7701_switch_cmd_bkx(st7701, true, 0);
	...
	ST7701_WRITE(st7701, 0xE0, 0x00, 0x00, 0x02);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE1, 0x02, 0x8C, 0x00, 0x00, 0x03, 0x8C, 0x00, 0x00, 0x00, 0x33, 0x33);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE2, 0x33, 0x33, 0x33, 0x33, 0xC9, 0x3C, 0x00, 0x00, 0xCA, 0x3C, 0x00, 0x00, 0x00);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE3, 0x00, 0x00, 0x33, 0x33);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE4, 0x44, 0x44);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE5, 0x05, 0xCD, 0x82, 0x82, 0x01, 0xC9, 0x82, 0x82, 0x07, 0xCF, 0x82, 0x82, 0x03, 0xCB, 0x82, 0x82);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE6, 0x00, 0x00, 0x33, 0x33);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE7, 0x44, 0x44);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE8, 0x06, 0xCE, 0x82, 0x82, 0x02, 0xCA, 0x82, 0x82, 0x08, 0xD0, 0x82, 0x82, 0x04, 0xCC, 0x82, 0x82);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xEB, 0x08, 0x01, 0xE4, 0xE4, 0x88, 0x00, 0x40);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xEC, 0x00, 0x00, 0x00);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xED, 0xFF, 0xF0, 0x07, 0x65, 0x4F, 0xFC, 0xC2, 0x2F, 0xF2, 0x2C, 0xCF, 0xF4, 0x56, 0x70, 0x0F, 0xFF);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xEF, 0x10, 0x0D, 0x04, 0x08, 0x3F, 0x1F);
	st7701_switch_cmd_bkx(st7701, false, 0);
	ST7701_WRITE(st7701, 0x3A, 0x66);
	st7701_switch_cmd_bkx(st7701, false, 0);
	ST7701_WRITE(st7701, 0x11);
	msleep(120);
}

static void er_tft_3_71_1_gip_sequence(struct st7701 *st7701)
{
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xC0, 0x77, 0x00);
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xC1, 0x11, 0x0C);
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xC2, 0x07, 0x02);
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xC3, 0x80, 0x10, 0x10);
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xB0, 0x06, 0xCF, 0x14, 0x0C, 0x0F, 0x03, 0x00, 0x0A, 0x07, 0x1B, 0x03, 0x12, 0x10, 0x25, 0x36, 0x1E);
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xB1, 0x0C, 0xD4, 0x18, 0x0C, 0x0E, 0x06, 0x03, 0x06, 0x08, 0x23, 0x06, 0x12, 0x10, 0x30, 0x2F, 0x1F);
	st7701_switch_cmd_bkx(st7701, true, 3);
	ST7701_WRITE(st7701, 0xEF, 0x08);
	st7701_switch_cmd_bkx(st7701, true, 0);
	ST7701_WRITE(st7701, 0xCC, 0x30);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xB9, 0x10, 0x1F);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xC2, 0x08);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE0, 0x00, 0x00, 0x02, 0x00, 0x00, 0x0C);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE1, 0x05, 0x96, 0x07, 0x96, 0x06, 0x96, 0x08, 0x96, 0x00, 0x44, 0x44);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE2, 0x00, 0x00, 0x03, 0x03, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x02, 0x00);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE3, 0x00, 0x00, 0x33, 0x33);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE4, 0x44, 0x44);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE5, 0x0D, 0xD4, 0x28, 0x8C, 0x0F, 0xD6, 0x28, 0x8C, 0x09, 0xD0, 0x28, 0x8C, 0x0B, 0xD2, 0x28, 0x8C);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE6, 0x00, 0x00, 0x33, 0x33);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE7, 0x44, 0x44);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xE8, 0x0E, 0xD5, 0x28, 0x8C, 0x10, 0xD7, 0x28, 0x8C, 0x0A, 0xD1, 0x28, 0x8C, 0x0C, 0xD3, 0x28, 0x8C);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xEB, 0x00, 0x01, 0xE4, 0xE4, 0x44, 0x00);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xED, 0xF3, 0xC1, 0xBA, 0x0F, 0x66, 0x77, 0x44, 0x55, 0x55, 0x44, 0x77, 0x66, 0xF0, 0xAB, 0x1C, 0x3F);
	st7701_switch_cmd_bkx(st7701, true, 1);
	ST7701_WRITE(st7701, 0xEF, 0x10, 0x0D, 0x04, 0x08, 0x3F, 0x1F);
	st7701_switch_cmd_bkx(st7701, true, 3);
	ST7701_WRITE(st7701, 0xE8, 0x00, 0x0E);
	...
	ST7701_WRITE(st7701, 0xE8, 0x00, 0x0C);
	st7701_switch_cmd_bkx(st7701, true, 3);
	ST7701_WRITE(st7701, 0xE8, 0x40, 0x00);
	st7701_switch_cmd_bkx(st7701, false, 0);
	ST7701_WRITE(st7701, 0x3A, 0x66);
	st7701_switch_cmd_bkx(st7701, false, 0);
	ST7701_WRITE(st7701, 0x11);
			    ...
			    struct drm_connector *connector)
{
	...
	// bus format setting for spi/dpi displays
	if (st7701->bus_format) {
		dev_info(panel->dev, "setting bus format 0x%04x\n",
			 st7701->bus_format);
		drm_display_info_set_bus_formats(&connector->display_info, 
						&st7701->bus_format, 1);
	} else {
		dev_warn(panel->dev, "no bus format specified\n");
	}
...
static const struct drm_display_mode er_tft_4_58_1_mode = {
	.clock		= 13002,
...
static const struct st7701_panel_desc er_tft_4_58_1_desc = {
	.mode = &er_tft_4_58_1_mode, 
	.lanes = 2,

	.panel_sleep_delay = 80, // reference used 78ms

	.pv_gamma = {
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x1) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC0_MASK, 0x0),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC4_MASK, 0x14),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC8_MASK, 0x19),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC16_MASK, 0x10),
		...
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC147_MASK, 0x5),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC175_MASK, 0x1e),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC203_MASK, 0x5),
		...
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x1) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC247_MASK, 0x28),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC251_MASK, 0x33),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC255_MASK, 0x15)
	},
	.nv_gamma = {
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x1) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC0_MASK, 0x0),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC4_MASK, 0x8),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC8_MASK, 0x13),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC16_MASK, 0x9),

		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC24_MASK, 0x11),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC52_MASK, 0x9),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC80_MASK, 0x2),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC108_MASK, 0x7),

		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC147_MASK, 0x9),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC175_MASK, 0x1a),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC203_MASK, 0x4),
		...
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC251_MASK, 0x29),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC255_MASK, 0x9)
	},
	.nlinv = 7,
	.vop_uv = 4900000,
	.vcom_uv = 462500,
	...
	.t3d_ns = 60000,
	.eot_en = true,
	.gip_sequence = er_tft_4_58_1_gip_sequence,
};


static const struct drm_display_mode er_tft_3_71_1_mode = {
    .clock = 11125, 
...
static const struct st7701_panel_desc er_tft_3_71_1_desc = {
	.mode = &er_tft_3_71_1_mode, 
	.lanes = 2,
	...
	.pv_gamma = {
        ...
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x3) |
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC8_MASK, 0x14),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC16_MASK, 0xc),

        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC24_MASK, 0xf),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC52_MASK, 0x3),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC80_MASK, 0x0),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC108_MASK, 0xa),

        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC147_MASK, 0x7),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC175_MASK, 0x1b),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC203_MASK, 0x3),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC231_MASK, 0x12),

        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC239_MASK, 0x10),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x0) |
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC247_MASK, 0x25),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC251_MASK, 0x36),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x0) |
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC255_MASK, 0x1e)
    },
	.nv_gamma = {
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x0) |
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC0_MASK, 0xc),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC4_MASK, 0x14),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x3) |
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC8_MASK, 0x18),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC16_MASK, 0xc),

        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC24_MASK, 0xe),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC52_MASK, 0x6),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC80_MASK, 0x3),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC108_MASK, 0x6),

        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC147_MASK, 0x8),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC175_MASK, 0x23),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC203_MASK, 0x6),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC231_MASK, 0x12),

        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC239_MASK, 0x10),
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0x0) |
        CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC247_MASK, 0x30),
	...
	.t3d_ns = 60000,
	.eot_en = true,
	.gip_sequence = er_tft_3_71_1_gip_sequence,
};
...
static int st7701_probe(struct device *dev, int connector_type)
{
	...
	dev_info(dev, "bus_format: 0x%08x\n", st7701->bus_format);
...
static int st7701_dsi_probe(struct mipi_dsi_device *dsi)
{
	...
	dev_info(&dsi->dev, "Initialized ST7701 MIPI DSI panel driver\n");
...
static int st7701_spi_probe(struct spi_device *spi)
{
	...
	dev_info(&spi->dev, "Initialized ST7701 SPI panel driver\n");
...
static const struct of_device_id st7701_spi_of_match[] = {
	...
	{ .compatible = "murdoa,er-tft-4.58-1", .data = &er_tft_4_58_1_desc },
	{ .compatible = "murdoa,er-tft-3.71-1", .data = &er_tft_3_71_1_desc },
	{ /* sentinel */ }
};
